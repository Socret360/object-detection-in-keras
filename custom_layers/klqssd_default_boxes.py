...
from utils.klqssd_utils import generate_default_boxes_for_feature_map


class KLQSDDDefaultBoxes(Layer):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.offset = offset
        super(KLQSDDDefaultBoxes, self).__init__(**kwargs)
    ...
    def build(self, input_shape):
        ...
        super(KLQSDDDefaultBoxes, self).build(input_shape)
    ...
    def get_config(self):
        ...
        base_config = super(KLQSDDDefaultBoxes, self).get_config()
