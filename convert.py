...
parser = argparse.ArgumentParser(description='Converts a supported model into tflite.')
...
parser.add_argument('--output_type', type=str, help='the type of the output model. One of type: "keras", "tflite"', default="keras")
...
if args.output_type == "keras":
    ...
    open(os.path.join(args.output_dir, f"{config_file_name}.tflite"), 'wb').write(tflite_model)
