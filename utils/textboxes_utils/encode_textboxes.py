...
def encode_textboxes(y, epsilon=10e-5):
    ...
    encoded_gt_textboxes_x1 = (gt_textboxes[:, 4] - df_boxes_vertices[:, 0, 0]) / df_boxes[:, 2]
    encoded_gt_textboxes_y1 = (gt_textboxes[:, 5] - df_boxes_vertices[:, 0, 1]) / df_boxes[:, 3]
    encoded_gt_textboxes_x2 = (gt_textboxes[:, 6] - df_boxes_vertices[:, 1, 0]) / df_boxes[:, 2]
    encoded_gt_textboxes_y2 = (gt_textboxes[:, 7] - df_boxes_vertices[:, 1, 1]) / df_boxes[:, 3]
    encoded_gt_textboxes_x3 = (gt_textboxes[:, 8] - df_boxes_vertices[:, 2, 0]) / df_boxes[:, 2]
    encoded_gt_textboxes_y3 = (gt_textboxes[:, 9] - df_boxes_vertices[:, 2, 1]) / df_boxes[:, 3]
    encoded_gt_textboxes_x4 = (gt_textboxes[:, 10] - df_boxes_vertices[:, 3, 0]) / df_boxes[:, 2]
    encoded_gt_textboxes_y4 = (gt_textboxes[:, 11] - df_boxes_vertices[:, 3, 1]) / df_boxes[:, 3]
