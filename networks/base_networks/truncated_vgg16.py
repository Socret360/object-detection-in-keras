...
def TRUNCATED_VGG16(input_shape=None):
    """ A truncated version of VGG16 configuration D
    """
    input_layer = Input(shape=input_shape, name="input")
    # block 1
    conv1_1 = Conv2D(64, (3, 3), activation='relu', padding='same', name='block1_conv1')(input_layer)
    ...
    # block 4
    conv4_1 = Conv2D(512, (3, 3), activation='relu', padding='same', name='block4_conv1')(pool3)
