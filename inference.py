...
if model_config["name"] == "ssd_vgg16":
    model, label_maps, process_input_fn = inference_utils.inference_ssd_vgg16(config, args)
elif model_config["name"] == "ssd_mobilenetv1":
    model, label_maps, process_input_fn = inference_utils.inference_ssd_mobilenetv1(config, args)
elif model_config["name"] == "ssd_mobilenetv2":
    model, label_maps, process_input_fn = inference_utils.inference_ssd_mobilenetv2(config, args)
elif model_config["name"] == "tbpp_vgg16":
    model, label_maps, process_input_fn = inference_utils.inference_tbpp_vgg16(config, args)
else:
